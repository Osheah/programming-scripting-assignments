...
factors=range(10,21) # 1-10 found already as noted in the question
while n>1: # while x is greater than 1
  for f in factors: 
...
#program takes a long time to run and would be faster if prime factorization was used (which I can do on paper but not on python - yet)
